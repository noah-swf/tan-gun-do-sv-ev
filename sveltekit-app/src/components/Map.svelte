<hr class="border-t-1.5 border-gray-300 mx-10 mt-10 md:mb-0"/>
<section class="flex flex-col md:flex-row justify-center gap-10 my-8 px-8">
  <div class="flex flex-col">
    <h1 class="text-2xl font-semibold text-gray-800 mb-4">Unser Dojang</h1>
    <iframe
      class="border border-gray-300 rounded-xl w-full md:w-[800px] h-[300px] md:h-[600px]"
  ...
  <div class="flex flex-col text-center justify-center md:text-left space-y-2">
    <p class="font-semibold">GSG Jugendhalle Schonnebeck</p>
    <p class="font-thin text-gray-500">Saatbruchstraße 52, 45309 Essen Schonnebeck</p>
