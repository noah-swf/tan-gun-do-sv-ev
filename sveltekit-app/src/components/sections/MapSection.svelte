<hr class="border-t-1.5 border-gray-200 mt-20 md:mb-0 max-w-6xl mx-auto"/>
<section class="flex flex-col md:flex-row justify-center gap-10 my-20 md:my-30 max-w-6xl mx-auto">
